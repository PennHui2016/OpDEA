...
preprocessing_raw_deqms<-function(mat, counts, design, imput='MinProb',normal='lossf', log2=T){
  library(MSnbase)
  library(GMSimpute)
  library(SeqKnn)
  library(rrcovNA)
  ...
  set.seed(123)
  pro_file<-mat
  colnames(pro_file)[c(1:2)]<-c('Protein', 'Organism')
