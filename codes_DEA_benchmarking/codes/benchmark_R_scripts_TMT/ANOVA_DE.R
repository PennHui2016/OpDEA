...
write.table(res_all, paste0(save_fold, dataset, '_ANOVA_', platform, '_', inten_type, '_', imput, '_', normal, '.csv'), sep = ',', row.names = TRUE, col.names = TRUE)
