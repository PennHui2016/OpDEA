...
def cal_mse_auc(tool, acq, in_type, inten_ty, imput, normal, res_file, dataset, run_time, in_files, comb_idx):
    if(os.path.exists(res_file)):
        ...
        out1 = [tool, in_type, inten_ty, imput, normal, comb_idx, run_time]
        out2 = [tool, in_type, inten_ty, imput, normal, comb_idx]
        out3 = [tool, in_type, inten_ty, imput, normal, comb_idx, run_time]
        out4 = [tool, in_type, inten_ty, imput, normal, comb_idx]
        ...
        aucs, paucs1,  paucs2, paucs3, sprs, rmses, lens, Cls_met_1_001, Cls_met_1_005 = cal_auc(score_c, label_c, const_c, p, logFC_c,
                                                                               real_logFC_c)
        out5 = [tool, in_type, inten_ty, imput, normal, comb_idx, run_time]
        out6 = [tool, in_type, inten_ty, imput, normal, comb_idx]
        out7 = [tool, in_type, inten_ty, imput, normal, comb_idx, run_time]
        out8 = [tool, in_type, inten_ty, imput, normal, comb_idx]
        out5.extend(lens)
        out5.extend(aucs)
        out5.extend(sprs)
        out5.extend(rmses)
...
def run_Rscript(acq, tool, in_type, inten_ty, imput, normal, in_files, dataset, comb_idx):
    '''
    :param tool: DE tool
    ...
    :return: DE results
    '''
    save_fold = in_files['save'] + dataset + '_' + acq + '/' + tool + '/' + str(comb_idx) + '/'
    t1 = time.time()
    ...
    cal_mse_auc(tool, acq, in_type, inten_ty, imput, normal, res_file_name, dataset, run_time, in_files, comb_idx)


def run_all_group1(acq, tools, in_type, imputs, normals, in_files, dataset, comb_idx):
        ...
        for inten_ty in inten_types:
            for imput in imputs:
                for normal in normals:
                    run_Rscript(acq, tool, in_type, inten_ty, imput, normal, in_files, dataset, comb_idx)

def run_all_group2(acq, tools, in_type, imputs, normals, in_files, dataset, comb_idx):
    for tool in tools:
        for imput in imputs:
            for normal in normals:
                run_Rscript(acq, tool, in_type, 'basic', imput, normal, in_files, dataset, comb_idx)

def run_Mstats(acq, in_files, in_type, dataset, comb_idx):
    in_files.update({'design':in_files['design_stat']})
    for normal in ['equalizeMedians', 'quantile', 'globalStandards', 'FALSE']:
        run_Rscript(acq, 'MSstats', in_type, 'basic', 'blank', normal, in_files, dataset, comb_idx)
...
def run_all(acq, in_files, dataset, in_type, flag, comb_idx):
    ...
    if flag == 1:
        run_all_group1(acq, tool_group1, in_type, imputs1, normals, in_files, dataset, comb_idx)
    elif flag == 2:
        run_all_group2(acq, tool_group2, in_type, imputs1, normals, in_files, dataset, comb_idx)
    elif flag == 3:
        run_all_group1(acq, tool_group3, in_type, imputs1, normals, in_files, dataset, comb_idx)

    elif flag == 4:
        run_Mstats(acq, in_files, in_type, dataset, comb_idx)
    elif flag == 5:
        run_all_group1(acq, tool_group7, in_type, imputs1, normals, in_files, dataset, comb_idx)
    elif flag == 6:
        run_all_group1(acq, tool_group4, in_type, imputs1, normals, in_files, dataset, comb_idx)
    elif flag == 7:
        run_all_group1(acq, tool_group5, in_type, imputs1, normals, in_files, dataset, comb_idx)
    elif flag == 8:
        run_all_group1(acq, tool_group6, in_type, imputs1, normals, in_files, dataset, comb_idx)
...
if __name__ == '__main__':
    ...
    if acq == 'DIA':
        if in_type == 'maxquant':
            ...
            in_files = {'protein': '/data/res_DE_files/he_dia_data/report.pg_matrix' + str(comb_idx) + '.tsv',
                        'protein1': '/data/res_DE_files/he_dia_data/report' + str(comb_idx) + '.tsv',
                        'peptide': '/home/hui/Documents/VM_share/DIA_data/yeast/frager/combined_peptide.tsv',
                        'design1': '/data/res_DE_files/he_dia_data/design' + str(comb_idx) + '.txt',
                        'design': '/data/res_DE_files/he_dia_data/design' + str(comb_idx) + '.txt',
                        'msstats': '/home/hui/Documents/VM_share/DIA_data/A549_K562/MSstats.csv',
                        'save': '/data/res_DE_files/benchmark_res/',
                        ...
                        'pro_path': '/home/hui/Documents/VM_share/DIA_data/he_diann/'
                        }
    elif acq == 'DDA':
        if in_type == 'maxquant':
            in_files = {'protein': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/combined/txt/proteinGroups' + str(comb_idx) + '.txt',
                        'peptide': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/combined/txt/peptides' + str(comb_idx) + '.txt',
                        'design': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/design_he_mq' + str(comb_idx) + '.txt',
                        'msstats': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/combined/txt/evidence' + str(comb_idx) + '.txt',
                        'save': '/home/hui/PycharmProjects/DL_proteomics/benchmark_res/',
                        'design_stat': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/design_he' + str(comb_idx) + '_msstats.txt',
                        'labels': '/home/hui/Documents/VM_share/DIA_data/A549_K562/CL_labeling.txt',
                        'database': '/home/hui/Documents/VM_share/DIA_data/ecoli_human.fasta',
                        'pro_path': '/home/hui/Documents/VM_share/DIA_data/he_diann/'}
        elif in_type == 'fragpipe':
            in_files = {'protein': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/frag/combined_protein' + str(comb_idx) + '.tsv',
                        'peptide': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/frag/combined_peptide' + str(comb_idx) + '.tsv',
                        'design': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/design_he_frag' + str(comb_idx) + '.txt',
                        'msstats': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/frag/MSstats' + str(comb_idx) + '.csv',
                        'save': '/home/hui/PycharmProjects/DL_proteomics/benchmark_res/',
                        'design_stat': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/design_he' + str(comb_idx) + '_msstats.txt',
                        'labels': '/home/hui/Documents/VM_share/DIA_data/A549_K562/CL_labeling.txt',
                        'database':'/home/hui/Documents/VM_share/DIA_data/ecoli_human.fasta',
    ...
    run_all(acq, in_files, dataset, in_type, flag, comb_idx)
