...
save_folder = 'ensemble_metrics_topK_mean_DIA/'
...
if __name__ == '__main__':
    ...
    dataset = 'human_ecoli_DIA'  ## A549-K562
    comb_idxs = [i for i in range(1, 35)]

    for in_type in ['DIANN']:
        acq = 'DIA'
        ...
        for comb_idx in comb_idxs:
            for k in [2, 3, 5, 7, 9, 11, 15, 20]:
                    ...
                    if in_type == 'maxquant':
                        in_files = {
                            ...
                            'peptide': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/combined/txt/peptides' + str(
                                comb_idx) + '.txt',
                            'design': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/design_he_mq' + str(
                                comb_idx) + '.txt',
                        ...
                        in_files = {
                            'protein': '/home/hui/Documents/VM_share/DIA_data/human_ecoli/frag/combined_protein' + str(
                                comb_idx) + '.tsv',
                ...
                wfs = getwfs('/data/res_DE_files/DIA_rank_mean', k, dataset, comb_idx)
...
# ##################################################################################
# ##############################################################################
    dataset = 'ecoli_DIA'  ## A549-K562

    modes = ['Narrow', 'Overlap', 'Wide', 'Variable']
    for in_type in ['DIANN']:
        acq = 'DIA'
        for mode in modes:
            for k in [2, 3, 5, 7, 9, 11, 15, 20]:
                ...
                if acq == 'DIA':
                    ...
                    if in_type == 'maxquant':
                        in_files = {
                            'protein': '/home/hui/Documents/VM_share/DIA_data/yeast/maxquant/txt/proteinGroups.txt',
                        ...
                        in_files = {
                            'protein': '/home/hui/Documents/VM_share/DIA_data/yeast/frager/combined_protein.tsv',
                            'peptide': '/home/hui/Documents/VM_share/DIA_data/yeast/frager/combined_peptide.tsv',
                            'design': '/home/hui/Documents/VM_share/DIA_data/yeast/design_yeast.txt',
                ...
                wfs = getwfs('/data/res_DE_files/DIA_rank_mean', k, dataset, mode)
